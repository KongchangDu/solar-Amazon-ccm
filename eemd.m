%function allmode=eemd(Y,Nstd,NE,SN,TNM)
%
...
%       This code limited sift number=SN ,the stoppage criteria can't change. 
%
% References:   
...
%     7.sift SN times to get IMF--------------------------sift loop  start  and end
%     8.after SN times sift --we got IMF
...
% 
% A. Antico, 20/03/2014: Two new inputs: (i) SN for number of sift 
% iterations and (ii) TNM for the total number of modes. TNM is 
% about fix(log2(N)), where N is the length of the input data Y.
